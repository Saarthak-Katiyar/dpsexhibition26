/*
  ...
  Fields:
    ...
    rooms     complete list of every room hosting this exhibition
...
window.EXHIBITIONS = [
  {
    ...
    category: "STEM",
    area: "2nd & 3rd Floor",
    location: "V A · V B · V C · VI A · VI B · BIO LAB",
    rooms: ["V A", "V B", "V C", "VI A", "VI B", "XI B2 (BIO LAB)"],
    ...
    projects: ["Renewable Energy", "Human Biology", "Space Exploration"],
    color: "#4ADE80"
  },
  {
    id: "mathematics",
  ...
  },
  {
    ...
    about: "Meet the machines students have designed, built and taught to think. Autonomous rovers, computer-vision systems and smart-agriculture prototypes in the Physics Lab.",
  ...
  },
  {
    ...
    category: "TECHNOLOGY",
    area: "2nd & 3rd Floor",
    location: "VI C · VI D · V E · COMP LAB (jr.)",
    rooms: ["VI C", "VI D", "V E", "COMP LAB (jr.)"],
  ...
  },
  {
    ...
    projects: ["Classical Recitals", "Contemporary Sets", "Choreography Demos"],
    color: "#FB7185"
  },
  {
    id: "hindi",
